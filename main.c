...
int main( void ) {
  ...
  //uart2
  uart2_config();
  //driveRGBWLightPwm(128,128,128,128);//test pwm driver
...
*/  
    ...
    if (mutex == 1) {
      ...
      //add by googy 11/17/2016
      Uart2SendString(pMsg);//send data to stm8s003f3
